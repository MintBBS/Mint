...
public class Apysts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acountno = findViewById(R.id.textViewApystsAccountNumber);
        nomineename = findViewById(R.id.textViewApyStsNomineeName);
        nomineeaadhar = findViewById(R.id.textViewApyStsNomineeAadhar);
        scheme_id = findViewById(R.id.textViewApyStsSchemeId);
